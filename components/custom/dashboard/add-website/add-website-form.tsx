 ...
 return (
  ...
  >
    ...
    <div className="absolute inset-0 -z-10 flex justify-center">
      <div className="w-[420px] h-[420px] bg-emerald-500/20 blur-[120px] rounded-full" />
    </div>
    ...
    <div className="text-center space-y-6 mb-14">
      ...
      <p className="text-muted-foreground max-w-xl mx-auto text-base leading-relaxed">
        Securely connect your website to Authiq. Once registered, your domain is
        locked for verification and API access.
      </p>
    </div>
