...
export function PricingCard({ title, price, description, features, isPro, index }: PricingCardProps) {
  return (
    <motion.div
          ...
          <div key={i} className="flex items-start gap-3 text-sm">
            <div
              className={cn(
                ...
                isPro ? "bg-emerald-500/20 text-emerald-500" : "bg-white/10 text-white",
              )}
            >
